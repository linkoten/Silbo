...
import { materielFormSchema } from "./userFormSchema"; // Ou le chemin correct
...
const CreateMaterielPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.details || "Erreur lors de la création du materiel"
        );
      }

      // Redirection vers la liste des materiels après création réussie
      navigate("/materiels");
    } catch (err) {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">Ajouter un nouveau materiel</h1>
