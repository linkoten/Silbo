...
interface ServicePersonnelTabProps {
  personnels: Personnel[];
  serviceId: string;
}

const ServicePersonnelTab: React.FC<ServicePersonnelTabProps> = ({
  personnels,
  serviceId,
}) => {
    ...
    return (
      <div className="overflow-x-auto">
        ...
        <div className="mt-6 flex justify-center">
          <Link
            to={`/personnels/create?serviceId=${serviceId}`}
...
export default ServicePersonnelTab;
